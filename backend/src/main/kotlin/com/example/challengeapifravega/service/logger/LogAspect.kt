package com.example.challengeapifravega.service.logger
...
class LogAspect {
    ...
    @Around("@annotation(com.example.challengeapifravega.service.logger.LogExecution)")
    fun logExecutionTime(joinPoint: ProceedingJoinPoint): Any {
        ...
        val result = try {
            ...
            logger.error("*** Exception during executing $signature, ${throwable.javaClass} - message: ${throwable.message}")
            throw throwable
        }
